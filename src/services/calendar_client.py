...
class CalendarClient:
    ...
    def create_event(self, event: CalendarEvent) -> str | None:
        ...
        try:
            ...
            logger.info("Creating calendar event", summary=event.summary, start=event.start_time)
            ...
            logger.info("Created calendar event", event_id=event_id, summary=event.summary)

            return event_id

        except HttpError as error:
            logger.error("Failed to create calendar event", error=str(error), summary=event.summary)
            return None
    ...
    def get_event(self, event_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            if error.resp.status == 404:
                ...
                return None
            logger.error("Failed to get calendar event", event_id=event_id, error=str(error))
            return None
    ...
    def update_event(self, event_id: str, event: CalendarEvent) -> bool:
        ...
        try:
            ...
            logger.info("Updating calendar event", event_id=event_id, summary=event.summary)
            ...
            logger.error("Failed to update calendar event", event_id=event_id, error=str(error))
            return False
    ...
    def delete_event(self, event_id: str) -> bool:
        ...
        try:
            ...
            logger.error("Failed to delete calendar event", event_id=event_id, error=str(error))
            return False
    ...
    def find_events_by_source_email(self, source_email_id: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.info("Found events by source email",
            ...
            logger.error("Failed to find events by source email",
                        source_email_id=source_email_id,
                        error=str(error))
            return []

    def check_event_exists(self, source_email_id: str, confirmation_code: str | None = None) -> bool:
    ...
    def find_events_by_confirmation_code(self, confirmation_code: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            events = events_result.get("items", [])
            logger.info("Found events by confirmation code",
                       confirmation_code=confirmation_code,
                       count=len(events))
            ...
            logger.error("Failed to find events by confirmation code",
                        confirmation_code=confirmation_code,
                        error=str(error))
            return []
    ...
    def find_events_by_booking_reference(self, booking_reference: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Failed to find events by booking reference",
                        booking_reference=booking_reference,
                        error=str(error))
            return []
